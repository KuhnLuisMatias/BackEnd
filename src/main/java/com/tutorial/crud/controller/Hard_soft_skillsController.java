...
import com.tutorial.crud.service.Hard_soft_skillsService;
...
public class Hard_soft_skillsController {
    ...
    public ResponseEntity<Hard_soft_skills> actualizarHard_soft_skills(@PathVariable Long id, @RequestBody Hard_soft_skills hard_soft_skills){
        ...
        try {
            ...
            hard_soft_skillsEncontrado.setPorcentaje(hard_soft_skills.getPorcentaje());
            hard_soft_skillsEncontrado.setDescripcion(hard_soft_skills.getDescripcion());
